...
#Plot 4 Code#
png("plot4.png",width = 625, height = 625)
par(mfrow=c(2,2))
plot(E$Time,E$Global_active_power,pch=NA,type="l",xlab = "",ylab="Global Active Power (kilowatts)")
plot(E$Time,E$Voltage,pch=NA,type="l",xlab = "datetime",ylab="Voltage")
...
plot(E$Time,E$Global_reactive_power,pch=NA,type="l",xlab = "",ylab="Global Reactive Power (kilowatts)")
dev.off()
